...
import { JobRequest, Urgencia } from "../../types/types";
...
function JobRequestCard({ item }: { item: JobRequest }) {
  ...
  return (
    <View className="bg-gray-900 rounded-2xl p-4 border border-gray-800 mb-3">
      {/* Title row */}
      ...
      <View className="flex-row items-center justify-between border-t border-gray-800 pt-3">
        ...
        <View className="flex-row items-center">
          ...
          <Text className="text-gray-500 text-xs ml-1">{date}</Text>
        </View>
      </View>
    </View>
  );
    ...
    <SafeAreaView className="flex-1 bg-gray-950" edges={["top"]}>
      ...
      {loading ? (
        ...
        <FlatList
          ...
          renderItem={({ item }) => <JobRequestCard item={item} />}
