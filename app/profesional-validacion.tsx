  ...
  return (
    <SafeAreaView className="flex-1 bg-white dark:bg-gray-950">
      <View className="flex-1 items-center justify-center px-8">
        ...
        <Text className="mb-8 text-center text-base text-slate-600 dark:text-gray-300">
        ...
        <Pressable
          ...
          className="w-full rounded-2xl border border-slate-300 dark:border-gray-700 px-6 py-4"
        >
          <Text className="text-center text-base font-semibold text-slate-700 dark:text-gray-200">
            Cerrar sesión
          </Text>
        </Pressable>
      </View>
